package my.dahr.monopolyone.data.source.inventory
...
fun ItemParams.toRequest() = ItemsParamsData(
...
fun InventoryResponse.toInventory(): Inventory {
    return Inventory(
        code = code,
