...
class FriendsRepositoryImpl (private val friendsDataSource: FriendsDataSource): FriendsRepository {
    override suspend fun getFriendsList(friendsParams: ListParams): Returnable = suspendCoroutine { continuation ->
    ...
    override suspend fun getFriendsRequestsList(requestsParams: RequestsParams): Returnable = suspendCoroutine { continuation ->
    ...
    override suspend fun addFriend(addParams: AddParams): Returnable = suspendCoroutine { continuation ->
    ...
    override suspend fun deleteFriend(deleteParams: DeleteParams): Returnable = suspendCoroutine { continuation ->
